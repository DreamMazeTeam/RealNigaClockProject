...
/**	пользовательские функции **/
			RTC::RTC(uint8_t RTC_selected_module, uint8_t RTC_line_resss, uint8_t RTC_line_clk, uint8_t RTC_line_dat){
...
void		RTC::blinktime(uint8_t RTC_i){RTC_uint_BLINK=RTC_i;}
